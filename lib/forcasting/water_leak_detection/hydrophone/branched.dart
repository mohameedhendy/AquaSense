...
class HydrophoneBranched extends StatefulWidget {
  @override
  State<HydrophoneBranched> createState() => _HydrophoneBranchedState();
}

class _HydrophoneBranchedState extends State<HydrophoneBranched> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Hydrophone Branched', style: TextStyle(color: Colors.black),),
        elevation: 0,
  ...
  Future<void> sendPredictionRequest(
    ...
    final apiUrl = 'https://watermanagement-b6i3.onrender.com/leak/hydrophonebranched';
