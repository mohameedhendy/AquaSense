...
class PressureLooped extends StatefulWidget {
  @override
  State<PressureLooped> createState() => _PressureLoopedState();
}

class _PressureLoopedState extends State<PressureLooped> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Pressure Looped', style: TextStyle(color: Colors.black),),
        elevation: 0,
  ...
  Future<void> sendPredictionRequest(
    ...
    final apiUrl = 'https://watermanagement-b6i3.onrender.com/leak/pressurelooped';
