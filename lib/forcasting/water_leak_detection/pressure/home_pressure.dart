import 'package:final_water_managment/forcasting/water_leak_detection/pressure/branched.dart';
import 'package:final_water_managment/forcasting/water_leak_detection/pressure/looped.dart';
...
class PressurePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Pressure', style: TextStyle(color: Colors.black),),
        elevation: 0,
