...
class PressureBranched extends StatefulWidget {
  @override
  State<PressureBranched> createState() => _PressureBranchedState();
}

class _PressureBranchedState extends State<PressureBranched> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Pressure Branched', style: TextStyle(color: Colors.black),),
        elevation: 0,
  ...
  Future<void> sendPredictionRequest(
    ...
    final apiUrl = 'https://watermanagement-b6i3.onrender.com/leak/pressurebranched';
