...
class AccelerometerLooped extends StatefulWidget {
  @override
  State<AccelerometerLooped> createState() => _AccelerometerLoopedState();
}

class _AccelerometerLoopedState extends State<AccelerometerLooped> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Accelerometer Looped', style: TextStyle(color: Colors.black),),
        elevation: 0,
              ...
              child: Column(
                ...
                children: [
                  ...
                  defaultFormField(
                    ...
                    enable: isEnabled,
                    validate: (value) {
                      if (value!.isEmpty) return 'sSnsor8 must not be empty';
                      return null;
                    },
                    type: TextInputType.number,
                  ),
  ...
  Future<void> sendPredictionRequest(
    ...
    final apiUrl = 'https://watermanagement-b6i3.onrender.com/leak/accelerometerlooped';
